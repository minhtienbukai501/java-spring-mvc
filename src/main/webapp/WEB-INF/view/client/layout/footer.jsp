                        ...
                        <div class="row g-4">
                            <div class="col-lg-3">
                                <a href="#">
                                    ...
                                    <p class="text-secondary mb-0">The best products of VietNam</p>
                                </a>
                            </div>
                            <div class="col-lg-6">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6 my-auto text-center text-md-end text-white">
                            ...
                            Designed By <a class="border-bottom" href="https://htmlcodex.com">JavaSpringBackEnd</a>
                            Distributed By <a class="border-bottom" href="https://themewagon.com">Lê Minh Tiến</a>
                        </div>
                    </div>
                </div>
            </div>
